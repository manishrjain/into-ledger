...
func TestLedgerFormat(t *testing.T) {
	...
	txn := Txn{Date: txnDate, Desc: "Payee", To: "Assets:Checking", From: "Expenses:Food", Cur: 123456789.02999999, CurName: "USD", Key: txnKey, skipClassification: false, Done: true}
	...
	t.Run("customTemplate", func(t *testing.T) {
		...
		want := "2013/02/03 * Payee\n    Assets:Checking           1.2345678902999999e+08 USD\n    Expenses:Food\n\n"
